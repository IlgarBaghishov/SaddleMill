...
write("optimized_reactant.vasp", reactant, format='vasp')
write("optimized_product.vasp", product, format='vasp')
...
write("reactant.vasp", sorted_reactant, format='vasp')
write("pproduct.vasp", sorted_product, format='vasp')
